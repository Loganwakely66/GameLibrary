...
namespace TicTacToe
{
    public class TicTac
    {
        ...
        Player[] players;//this goes in Player

        public TicTac()//this goes in Player
        {
        ...
        private void Start()//this goes in Player
        {
            ...
            while (!GameOver())
            {
                ...
                PrintBoard();//this is also part of board
        ...
        private void TakeTurn(Player activePlayer)//this goes in Player
        {
            int[] position = PiecePlacement(activePlayer);
            board[position[0], position[1]] = activePlayer.Token; //this is also part of board
        }
        ...
        /// <param name="activePlayer"></param>
        /// <returns></returns>
        private int[] PiecePlacement(Player activePlayer)//this goes in Player
        {
            ...
            PrintBoardMap();//this is also part of board
        ...
        /// </summary>
        private void PrintBoard()//this is also part of board
        {
            Console.WriteLine();
            for (int row = 0; row <= board.GetUpperBound(0); row++)
            {
